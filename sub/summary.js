window.__VPN_SUMMARY__ = {
  ...
  "service_probe": {
    ...
    "gemini_api_health": {
      ...
      "top_errors": [
        {
          "error": "api_error:Request had invalid authentication credentials. Expected OAuth 2 access token, login cookie or other valid aut",
          "count": 17
        }
      ]
    }
